...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { TypePartner_id: @partner.TypePartner_id, documents_id: @partner.documents_id, name: @partner.name, price: @partner.price } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { TypePartner_id: @partner.TypePartner_id, documents_id: @partner.documents_id, name: @partner.name, price: @partner.price } }
